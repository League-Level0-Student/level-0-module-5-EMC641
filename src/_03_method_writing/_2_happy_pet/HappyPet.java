...
public class HappyPet {
	...
	if(task==0) {
	JOptionPane.showMessageDialog(null, " Your pet likes to be walked, but is tired right now. Maybe later she wants to be walked");
	task-=5;
	}
	else if(task==1) {
		JOptionPane.showMessageDialog(null, " Your pet was very hungry.");
		task+=20;
	}
	else if(task==2) {
		JOptionPane.showMessageDialog(null, " Your pet does't like to play catch.");
		task-=10;
	}
